...
public class MovieShowBean {
	...
	public void addNewOrEditMovieShow() throws IOException, ParseException {
		...
		this.endTime = Timestamp.valueOf(startTime.toLocalDateTime()
				.plusMinutes(movieShowService.getMovieRepository().findMovieById(movieId).getLength()));
		...
		if (movieShowToBeEditedID == null) {
			...
			MovieShow editedMovieShow = movieShowService.getMovieShowRepository()
					.findMovieShowById(movieShowToBeEditedID);
