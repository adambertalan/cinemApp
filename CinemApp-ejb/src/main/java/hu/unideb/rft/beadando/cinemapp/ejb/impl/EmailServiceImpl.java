...
public class EmailServiceImpl implements EmailService {
	...
	public void sendEmail(String toEmailAddress, String type, String guestName, String guestMessage, String guestEmail,
		...
		try {
			...
			// Email header része
			String header = "    <table class=\"head-wrap w320 full-width-gmail-android\" bgcolor=\"#f9f8f8\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\n"
			...
			case "contacts":
				...
				footerContent = "";
				greeting = "";
				toEmailAddress = "cinemapp.fft@gmail.com";
				imageContent = "";
				break;
			...
			// <body>
			String body = "<body bgcolor=\"#ffffff\">\n" + "  <div align=\"center\">\n" + header + "\n"
